...
{
	[Serializable]
	[ProtoContract(Name = "S2CTrialStageRewardAck")]
	public class S2CTrialStageRewardAck : IExtensible
	{
		...
		[ProtoMember(4, IsRequired = true, Name = "TrialInfo", DataFormat = DataFormat.Default)]
