...
{
	[Serializable]
	[ProtoContract(Name = "S2CAccumulationSignAck")]
	public class S2CAccumulationSignAck : IExtensible
	{
		...
		public enum ResultCode
		{
			...
			Success = 1,
			[ProtoEnum(Name = "HasReceived", Value = 2)]
			HasReceived = 2
		}

		private ResultCode _Code;

		private AccumulationSignProto _Info;
		...
		public AccumulationSignProto Info
		{
			get => _Info;
			set => _Info = value;
		}
