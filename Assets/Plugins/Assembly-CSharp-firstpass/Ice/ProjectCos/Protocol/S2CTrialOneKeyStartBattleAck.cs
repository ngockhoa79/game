...
{
	[Serializable]
	[ProtoContract(Name = "S2CTrialOneKeyStartBattleAck")]
	public class S2CTrialOneKeyStartBattleAck : IExtensible
	{
		...
		[ProtoMember(3, IsRequired = true, Name = "TrialInfo", DataFormat = DataFormat.Default)]
