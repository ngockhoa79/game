...
{
	[Serializable]
	[ProtoContract(Name = "S2CUnEquipEquipmentAck")]
	public class S2CUnEquipEquipmentAck : IExtensible
	{
		...
		[ProtoMember(3, IsRequired = true, Name = "EquipmentIndex", DataFormat = DataFormat.TwosComplement)]
