...
{
	[Serializable]
	[ProtoContract(Name = "S2CGoddessGrailInfoAck")]
	public class S2CGoddessGrailInfoAck : IExtensible
	{
		...
		private GoddessGrailInfoProto.ConfigProto _ConfigInfo;
		...
		public GoddessGrailInfoProto.ConfigProto ConfigInfo
		{
			get
			{
				return null;
