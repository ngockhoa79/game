...
{
	[Serializable]
	[ProtoContract(Name = "S2CContinuousLoginRewardAck")]
	public class S2CContinuousLoginRewardAck : IExtensible
	{
		...
		private ContinuousLoginRewardProto _Info;
		...
		public ContinuousLoginRewardProto Info
		{
			get => _Info;
			set => _Info = value;
		}
